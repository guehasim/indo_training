...
<head>
  <meta charset="utf-8">
    ...
    <link href="<?=base_url('assets')?>/login/images/logo_atas.jpg" rel="shortcut icon">
</head>
    ...
    <div class="auth-2-outer row align-items-center h-p100 m-0">
        <div class="auth-2">
          ...
          <div class="auth-logo font-size-30">
            <img src="<?=base_url('assets/login/images/logo.jpg')?>" alt="" height="50">
          </div>
          <!-- /.login-logo -->
          <div class="auth-body">
